<?php
// drinks.php
$drinks = include 'drinks_data.php';
?>
...
<body>
    ...
    <h1 class="fastfood-header">Refreshing Drinks</h1>
    <div class="fastfood-grid">
        <?php foreach ($drinks as $drink): ?>
            <div class="fastfood-card" style="display:grid;grid-template-rows:160px 1fr auto auto;min-height:370px;">
                <img class="fastfood-img" src="<?php echo htmlspecialchars($drink['image']); ?>" alt="<?php echo htmlspecialchars($drink['name']); ?>">
                <div class="fastfood-title" style="font-size:1.18rem;font-weight:700;color:#23272b;margin:16px 0 8px 0;">
                    <?php echo htmlspecialchars($drink['name']); ?>
                </div>
                <div class="fastfood-desc" style="font-size:0.98rem;color:#444;margin-bottom:24px;">
                    <?php echo htmlspecialchars($drink['description']); ?>
                </div>
                <a href="dishdetails2.php?dish=<?php echo urlencode($drink['name']); ?>" class="fastfood-view-btn" style="margin-top:auto;margin-bottom:0;align-self:center;display:inline-block;padding:7px 18px;background:#97c933;color:#fff;border-radius:6px;text-decoration:none;font-weight:600;transition:background 0.2s;">View</a>
            </div>
        <?php endforeach; ?>
    </div>
