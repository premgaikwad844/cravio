...
<body>
    <nav class="navbar">
        <div class="navbar-logo-group">
            <a href="index.php"><img src="f2-removebg-preview.png" alt="fitmeal logo" class="navbar-logo-icon"></a>
            <div class="navbar-logo-text">
                <a href="index.php" style="text-decoration:none;"><span class="navbar-logo-title">Cravio</span></a>
            </div>
        </div> 
        <ul class="navbar-links">
            <li><a href="future.php">Home <span class="arrow">&#8250;</span></a></li>
            <li><a href="index.php">About us <span class="arrow">&#8250;</span></a></li>
            <li><a href="index.php">Products <span class="arrow">&#8250;</span></a></li>
            <li><a href="index.php">Contact Us <span class="arrow">&#8250;</span></a></li>
        </ul>
        <a href="index.php" class="navbar-btn">Get Menu</a>
        <div class="navbar-mobile-menu">
            <ul>
                <li><a href="future.php">Home</a></li>
        ...
        <div class="carousel-track">
            <div class="carousel-slide active" style="background-image: url('https://img.freepik.com/premium-photo/vibrant-colorful-variety-fresh-fruits-vegetables-are-arranged-together-creating-visually-appealing-nutritious-composition_14117-135270.jpg?w=2000');">
                ...
                <div class="carousel-content">
                    ...
                    <div class="carousel-buttons">
                        <a href="index.php" class="carousel-btn carousel-btn-explore"><span>Search All Products</span></a>
                    </div>
                </div>
            </div>
            <div class="carousel-slide" style="background-image: url('https://png.pngtree.com/thumb_back/fh260/background/20240204/pngtree-food-composition-for-ramadan-with-space-on-right-image_15589018.png');">
                ...
                <div class="carousel-content">
                    ...
                    <div class="carousel-buttons">
                        <a href="index.php" class="carousel-btn carousel-btn-explore"><span>Explore Fast Food</span></a>
                    </div>
                </div>
            </div>
            <div class="carousel-slide" style="background-image: url('https://img.freepik.com/premium-photo/vibrant-amazonian-ingredients-food-photography_753066-3265.jpg');">
                ...
                <div class="carousel-content">
                    ...
                    <div class="carousel-buttons">
                        <a href="index.php" class="carousel-btn carousel-btn-explore"><span>See Snacks</span></a>
                    </div>
                </div>
            </div>
            <div class="carousel-slide" style="background-image: url('https://wallpaperaccess.com/full/8500654.jpg');">
                ...
                <div class="carousel-content">
                    ...
                    <div class="carousel-buttons">
                        <a href="index.php" class="carousel-btn carousel-btn-explore"><span>See Desserts</span></a>
                    </div>
                </div>
            </div>
            <div class="carousel-slide" style="background-image: url('https://pachamamafoodsng.com/wp-content/uploads/2023/07/3-1.jpg');">
                ...
                <div class="carousel-content">
                    ...
                    <div class="carousel-buttons">
                        <a href="index.php" class="carousel-btn carousel-btn-explore"><span>See Nutritional Food</span></a>
                    </div>
                </div>
            </div>
            <div class="carousel-slide" style="background-image: url('https://img.freepik.com/free-photo/close-up-appetizing-ramadan-meal_23-2151182534.jpg');">
                ...
                <div class="carousel-content">
                    ...
                    <div class="carousel-buttons">
                        <a href="index.php" class="carousel-btn carousel-btn-explore"><span>See Drinks</span></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="menu-card">
          ...
          <div class="menu-card-content">
            ...
            <div class="menu-card-actions">
              <a href="index.php" class="menu-card-btn">View</a>
            </div>
          </div>
        </div>
        <div class="menu-card">
    ...
    <section class="search-cta-section">
      <div class="search-cta-content" style="position: relative; z-index: 2; max-width: 700px; margin: 0 auto; padding: 60px 24px 48px 24px; background: #97c933; border-radius: 24px; box-shadow: 0 8px 32px rgba(151,201,51,0.13); color: #fff;">
        <h2 style="margin-bottom: 1.2rem; color: #fff;"><a href="index.php" style="color:inherit;text-decoration:none;">Find Your Next Favorite Meal</a></h2>
        <p style="font-size: 1.18rem; color: #fff; margin-bottom: 2.2rem; line-height: 1.7;"><a href="index.php" style="color:inherit;text-decoration:none;">Discover a world of delicious possibilities! Our food search helps you quickly find meals that match your cravings, dietary needs, and lifestyle. Whether you want something healthy, indulgent, or new, we've got you covered.</a></p>
        <div style="margin-top: 2.5rem;">
          <div style="font-size: 1.13rem; color: #fff; margin-bottom: 1.2rem;"><a href="index.php" style="color:inherit;text-decoration:none;">Ready to explore? Start your food journey now:</a></div>
          <div class="carousel-buttons">
            <a href="index.php" class="carousel-btn carousel-btn-explore"><span>Search for Food</span></a>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="footer-content">
        <div class="footer-col footer-brand">
          <div class="footer-logo-row">
            <a href="index.php"><img src="f2-removebg-preview.png" alt="fitmeal logo" class="footer-logo-icon"></a>
            <div class="footer-logo-text">
              <a href="index.php" style="text-decoration:none;"><span class="footer-logo-title">Cravio</span></a>
            </div>
          </div>
          <p class="footer-desc" style="font-size: 0.98rem; color: #fff; margin-bottom: 1.2em; max-width: 340px;"><a href="index.php" style="color:inherit;text-decoration:none;">Cravio is your trusted companion for discovering, comparing, and enjoying the best food and drinks. We bring you curated recommendations, local favorites, and a seamless experience to satisfy every craving.</a></p>
          <div class="footer-socials" style="display: flex; gap: 18px; margin-bottom: 1.2em;">
            <a href="index.php"><img src="https://cdn-icons-png.flaticon.com/128/733/733547.png" alt="Facebook" style="width: 32px; height: 32px; display: inline-block;"></a>
            <a href="index.php"><img src="https://cdn-icons-png.flaticon.com/128/733/733558.png" alt="Instagram" style="width: 32px; height: 32px; display: inline-block;"></a>
          </div>
        </div>
        <div class="footer-col footer-links">
          <h3><a href="index.php" style="color:inherit;text-decoration:none;">Explore</a></h3>
          <ul>
            <li>Home</li>
            <li><a href="index.php">Products</a></li>
            <li><a href="index.php">About Us</a></li>
        ...
        <div class="footer-col footer-contact">
          <h3><a href="index.php" style="color:inherit;text-decoration:none;">Contact info</a></h3>
          <div class="footer-contact-item"><span class="footer-contact-icon">📍</span> <span><b>Our location:</b><br><a href="index.php" style="color:inherit;text-decoration:none;">Sangli, Maharashtra, India</a></span></div>
          <div class="footer-contact-item"><span class="footer-contact-icon">✉️</span> <span><b>Email:</b><br><a href="index.php" style="color:inherit;text-decoration:none;">demo@gmail.com</a></span></div>
        </div>
      </div>
    </footer>
