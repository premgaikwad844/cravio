<?php
// fastfood.php
$dishes = include 'fastfood_data.php';
?>
...
<body>
    ...
    <h1 class="fastfood-header">Popular Fast Food Dishes</h1>
    <div class="fastfood-grid">
        <?php foreach ($dishes as $dish): ?>
            <div class="fastfood-card" style="display:grid;grid-template-rows:160px 1fr auto auto;min-height:370px;">
                ...
                <div class="fastfood-title" style="font-size:1.18rem;font-weight:700;color:#23272b;margin:16px 0 8px 0;"><?php echo htmlspecialchars($dish['name']); ?></div>
                <div class="fastfood-desc" style="font-size:0.98rem;color:#444;margin-bottom:24px;"><?php echo htmlspecialchars($dish['description']); ?></div>
